...
interface AuthProps {
    ...
    onSignUp: (newUserData: Omit<User, 'id' | 'institutionId' | 'avatarUrl' | 'rollNumber' | 'avatarStyle'> & { institutionName?: string }) => void;
}
...
const Auth: React.FC<AuthProps> = ({ allUsers, onLogin, onSignUp }) => {
    ...
    const classLabel = role === UserRole.STUDENT ? translate('Class (e.g., Grade 8, Section A)') : translate('Department / Subject (e.g., Science)');
