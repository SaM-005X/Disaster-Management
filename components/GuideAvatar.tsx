...
const GuideAvatar: React.FC<GuideAvatarProps> = ({ message, mood, isOpen, onClose, avatarStyle, onClick }) => {
    ...
    return (
        <div className="fixed bottom-6 left-6 z-40 flex items-end gap-3 animate-fade-in-up">
            <button onClick={onClick} className="focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 dark:focus:ring-offset-gray-900 rounded-full" aria-label={translate("Open Safety Assistant")}>
